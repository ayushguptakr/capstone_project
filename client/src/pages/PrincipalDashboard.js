    ...
    <div className="min-h-screen bg-slate-50 font-body flex transition-colors">
      ...
      <main className="flex-1 overflow-y-auto">
        <header className="bg-white border-b border-slate-200 px-8 py-6 sticky top-0 z-10 shadow-sm">
          ...
          <p className="text-sm font-medium text-slate-500 mt-1">Review metrics and key performance indicators.</p>
        </header>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
                    ...
                    <p className="text-sm text-blue-600 mt-1">Class {topClass?._id || "N/A"} is leading the school in overall engagement and XT generation.</p>
                  </div>
                  <div className="bg-red-50 border border-red-100 rounded-xl p-4">
                    <p className="text-sm font-semibold text-red-800">Attention Required</p>
                    <p className="text-sm text-red-600 mt-1">Class {lowestClass?._id || "N/A"} has seen a 14% drop in active missions this week.</p>
                  </div>
                </div>
              </div>
            </>
